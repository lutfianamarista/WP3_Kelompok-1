		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<!-- <img src="../assets/img/mtslogo0.png" alt="navbar brand" class="navbar-brand" width="40"> -->
					<b class="text-white">SMA HIKMAH YAPIS</b>
				</a>
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMA HIKMAH YAPIS(<a href="index.php">Lutfi </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>

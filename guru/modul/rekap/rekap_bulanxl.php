 	...
 	<tr>
 		<td>
 			<center>
 				...
 				<h1>
 					ABSESNSI SISWA <br>
 					<small> SMA NEGERI 2 BINJAI</small>
 				</h1>
 				<hr>
 				<em>
 					Jl.Bukit Bunian Jorong Bukareh Kenagarian Koto Tangah Kecamatan Tilaga,<br> Kamang Kabupaten Agam, Provinsi Sumatera Utara, Kode Pos (26152) <br>
 				<b>Email : smanegeri2binjai@yahoo.com Telp.081266005679</b> 
 				</em>
...
<table width="100%">
	...
	<!-- 	<td align="left">
		...
		<td align="right">
			<p>
			 Sumatera Utara, <?php echo date('d-F-Y'); ?>
			</p>
			<p>
				Kepala Sekolah
				<br>
